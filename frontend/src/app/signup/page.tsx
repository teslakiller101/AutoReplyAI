            ...
            <div className="w-full max-w-md space-y-8 bg-white p-8 shadow-xl rounded-2xl border border-gray-100">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    <div className="space-y-4">
                        <div>
                            <input {...register('businessName')} type="text" placeholder="Business Name" className="block w-full rounded-lg border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 px-4" />
                            {errors.businessName?.message && <p className="text-red-500 text-sm mt-1">{String(errors.businessName.message)}</p>}
                        </div>
                        <div>
                    ...
                    <button type="submit" className="flex w-full justify-center rounded-lg bg-blue-600 px-4 py-3 text-sm font-semibold leading-6 text-white hover:bg-blue-500 transition shadow-md">Sign Up</button>
                </form>
            </div>
        </div>
    );
